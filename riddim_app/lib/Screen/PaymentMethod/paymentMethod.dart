...
import 'package:riddim_app/Screen/PaymentMethod/addcard.dart';
import 'package:riddim_app/Screen/PaymentMethod/card.dart';
...
class _PaymentMethodState extends State<PaymentMethod> {
  ...
  void getPaymentCards() async {
    if (_currentUser != null) {
      ...
      final results = await userRepository.getVouchers(
        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: Container(
                          ...
                          child: Text("Add a new WiPay voucher",style: textBoldBlack,)
                      ),
                    ),
                    Expanded(
                      flex: 1,
            ...
            Container(
              ...
              child: Text('WiPay Vouchers',style: textStyle,),
            ),
            Expanded(
                ...
                itemBuilder: (BuildContext context, index){
                  return Container(
                      ...
                      child: GestureDetector(
                          ...
                          child: card("assets/image/wipay.png",_listRequest[index]['name'],_listRequest[index]['amount']))); //creditCard("assets/image/image_" + _listRequest[index]['cardtype'] + ".png",_listRequest[index]['card'],_listRequest[index]['expiry']);
                }
              ),
            ),
          ],
  ...
  Widget card(String image, String name, String amount){
    return Container(
      padding: EdgeInsets.only(top: 10.0,bottom: 10.0,left: 10.0,right: 10.0),
      decoration: BoxDecoration(
          color: Colors.white,
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text(name,style: textBoldBlack,),
                Padding(
                  padding: EdgeInsets.only(bottom: 10.0),
                ),
                Text(amount,style: textGrey,)
              ],
            ),
          )
        ],
